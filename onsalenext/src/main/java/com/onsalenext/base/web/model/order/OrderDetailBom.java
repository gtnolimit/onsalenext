...
public class OrderDetailBom implements Comparable<OrderDetailBom>{
	...
	public OrderDetailBom (Long id, double price, int qty, String subject, PictureBom picture, ItemBom item){
		this.id = id;
		this.price = price;
		this.qty = qty;
	...
	public int compareTo(OrderDetailBom o) {
